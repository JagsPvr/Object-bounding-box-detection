...
model.load_weights("saved_weights/model_epoch_{}.h5".format(epoch_num))
...
for epoch in range(H.num_epochs) :
	...
	# logger.info("Validation - Epoch : {}, Val_Loss : {}".format(epoch, val_loss))
	model.save_weights("saved_weights/model_epoch_{}.h5".format(epoch_num + epoch + 1))
	logger.info("Model weights - model_epoch_{} saved".format(epoch_num+ epoch + 1))
